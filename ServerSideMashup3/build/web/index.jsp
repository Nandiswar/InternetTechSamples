...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="jsonpscript.js"></script>
    ...
    <!-- Make a request to heroku app to count the visits -->
    <body onload="updateCartDisplay(),cooljsonp()">
            ...
            <table border="1">
                ...
                <tbody>
                    ...
                    <tr><td><%= item.getName()%></td><td><%= item.getDescription()%></td><td>
                            ...
                            <button onclick="addToCart('<%= item.getCode()%>','<%= item.getName()%>','<%= item.getUrl()%>')">Add</button></td><td>
